package com.friendsofed.isometric
{
	...
	public class IsoUtils
	{
		...
		public static function screenToGrid(x:Number, y:Number):Point
		{
			var xpos:Number = y + x * .5;
			var ypos:Number = 0;
			var zpos:Number = y - x * .5;
			return new Point(Math.round(xpos / MapEnum.SIZE), Math.round(zpos / MapEnum.SIZE));
		}
	}
}